                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 flex-1 h-full">
                    ...
                    <div className="hidden lg:flex lg:col-span-3 flex-col bg-slate-900 text-white relative h-screen">
                        <div className="absolute inset-0 opacity-10">
                            <img
                                src="https://images.unsplash.com/photo-1516979187457-637abb4f9353?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
                                alt="Recupera tu acceso"
                        ...
                        <div className="relative z-10 p-16 flex flex-col justify-between h-full">
                            <div>
                                ...
                                <p className="text-lg text-slate-400 max-w-md">
                                    No te preocupes, te enviaremos un enlace de recuperación a tu correo electrónico.
                                </p>
                            </div>
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-semibold mb-1">Recuperación rápida</h3>
                                        <p className="text-sm text-slate-400">Recibirás el enlace en tu correo en segundos</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        <h3 className="font-semibold mb-1">Totalmente seguro</h3>
                                        <p className="text-sm text-slate-400">Proceso protegido y encriptado</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col justify-center items-center lg:col-span-2 bg-white p-8 md:p-16 h-screen">
                        <div className="w-full max-w-md">
                            ...
                            <p className="text-slate-600 mb-8">Ingresa tu correo para recibir el enlace de recuperación</p>
                                ...
                                {({ processing, errors }) => (
                                    <>
                                        ...
                                        <div className="text-center text-sm text-slate-600 pt-6 border-t border-slate-200">
                                            ...
                                            <TextLink href={login()} className="text-slate-900 hover:underline font-medium">
                                                Iniciar sesión
                                            </TextLink>
                                        </div>
                                    </>
